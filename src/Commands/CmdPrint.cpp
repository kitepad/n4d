...
void CCmdPrint::Print(bool bShowDlg)
{
    ...
    pagesetupMargin.left   = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginLeft", defaultMargin));
    pagesetupMargin.top    = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginTop", defaultMargin));
    pagesetupMargin.right  = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginRight", defaultMargin));
    pagesetupMargin.bottom = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginBottom", defaultMargin));
...
bool CCmdPageSetup::Execute()
{
    ...
    pDlg.rtMargin.left   = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginLeft", 2540));
    pDlg.rtMargin.top    = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginTop", 2540));
    pDlg.rtMargin.right  = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginTight", 2540));
    pDlg.rtMargin.bottom = static_cast<long>(GetInt64(DEFAULTS_SECTION, L"PageMarginBottom", 2540));

    if (!PageSetupDlg(&pDlg))
        return false;

    SetInt64(DEFAULTS_SECTION, L"PageMarginLeft", pDlg.rtMargin.left);
    SetInt64(DEFAULTS_SECTION, L"PageMarginTop", pDlg.rtMargin.top);
    SetInt64(DEFAULTS_SECTION, L"PageMarginTight", pDlg.rtMargin.right);
    SetInt64(DEFAULTS_SECTION, L"PageMarginBottom", pDlg.rtMargin.bottom);
