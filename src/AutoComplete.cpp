...
void CAutoComplete::HandleAutoComplete(const SCNotification* scn)
{
    ...
    else if (forceShow || (CIniSettings::Instance().GetInt64(L"View", L"autocomplete", 1) && word.size() > 1))
    {
...
{
    const bool autoCompleteIgnoreCase = CIniSettings::Instance().GetInt64(L"View", L"autocompleteMatchCase", 0) != 1;
