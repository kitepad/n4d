...
#include "ILoader.h"
#include "ResString.h"
#include "../ext/sktoolslib/FormatMessageWrapper.h"
#include <stdexcept>
#include <Shobjidl.h>
#include <mlang.h>
#include <wrl/client.h>

#include "../ext/compact_enc_det/compact_enc_det/compact_enc_det.h"
#include "../ext/compact_enc_det/util/encodings/encodings.pb.h"
#include "../ext/compact_enc_det/util/languages/languages.pb.h"
...
CDocument CDocumentManager::LoadFile(/*HWND hWnd,*/ const std::wstring& path, int encoding, bool createIfMissing)
{
    ...
    bool  bFirst                  = true;
    bool  preferUtf8              = GetInt64(DEFAULTS_SECTION,L"PreferUTF8", 0) != 0;
