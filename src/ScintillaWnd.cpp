...
bool CScintillaWnd::Init(HINSTANCE hInst, HWND hParent, HWND hWndAttachTo)
{
    ...
    bool showFoldingMargin = CIniSettings::Instance().GetInt64(L"View", L"ShowFoldingMargin", 1) != 0;
    ...
    bool isWrap = CIniSettings::Instance().GetInt64(L"View", L"wrapmode", 0) != 0;
    ...
    //m_scintilla.SetEdgeColumn(ve);
    //m_scintilla.SetEdgeMode(ve ? Scintilla::EdgeVisualStyle::Line : Scintilla::EdgeVisualStyle::None);
...
void CScintillaWnd::MatchBraces(BraceMatch what)
{
    ...
    bool isBraceHighlightText = CIniSettings::Instance().GetInt64(L"View", L"bracehighlighttext", 1);
...
{
    m_scintilla.SetTabWidth(static_cast<uptr_t>(CIniSettings::Instance().GetInt64(L"View", L"tabwidth", 4)));
